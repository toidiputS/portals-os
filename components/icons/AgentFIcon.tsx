...
interface AgentFIconProps {
  className?: string;
  size?: number;
}

export const AgentFIcon: React.FC<AgentFIconProps> = ({
  className = "",
  size = 64,
}) => {
  return (
    <svg
      className={`holographic-icon agent-f-icon ${className}`}
      width={size}
      height={size}
      viewBox="0 0 64 64"
    ...
    >
      <defs>
        <linearGradient id="agentGradientF" x1="0%" y1="0%" x2="100%" y2="100%">
      ...
      {/* Glassmorphic flowing background */}
      <path
