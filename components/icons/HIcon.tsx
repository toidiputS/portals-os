...
export const HIcon: React.FC<HIconProps> = ({
  ...
  return (
    <svg
      className={`holo-h-icon ${className}`}
      width={size}
      height={size}
      viewBox="0 0 64 64"
    ...
    >
      <defs>
        <linearGradient id="gradientH" x1="0%" y1="0%" x2="100%" y2="100%">
        ...
        >
          <circle cx="4" cy="4" r="2" fill="rgba(156, 39, 176, 0.1)" />
          <circle cx="4" cy="4" r="1" fill="rgba(156, 39, 176, 0.2)" />
        </pattern>
      </defs>
      ...
      <circle cx="32" cy="32" r="18" fill="url(#gearPatternH)" opacity="0.4" />
