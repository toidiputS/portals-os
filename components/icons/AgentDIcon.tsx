...
interface AgentDIconProps {
  className?: string;
  size?: number;
}

export const AgentDIcon: React.FC<AgentDIconProps> = ({
  className = "",
  size = 64,
}) => {
  return (
    <svg
      className={`holographic-icon agent-d-icon ${className}`}
      width={size}
      height={size}
      viewBox="0 0 64 64"
    ...
    >
      <defs>
        <linearGradient id="agentGradientD" x1="0%" y1="0%" x2="100%" y2="100%">
