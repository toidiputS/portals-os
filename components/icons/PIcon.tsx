...
export const PIcon: React.FC<PIconProps> = ({
  ...
  return (
    <svg
      className={`holo-p-icon ${className}`}
      width={size}
      height={size}
      viewBox="0 0 64 64"
    ...
    >
      <defs>
        ...
        >
          <circle cx="4" cy="4" r="2" fill="rgba(255, 87, 34, 0.1)" />
          <circle cx="4" cy="4" r="1" fill="rgba(255, 87, 34, 0.2)" />
        </pattern>
      </defs>
      ...
      <circle cx="32" cy="32" r="18" fill="url(#gearPatternP)" opacity="0.4" />
