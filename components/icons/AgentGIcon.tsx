...
interface AgentGIconProps {
  className?: string;
  size?: number;
}

export const AgentGIcon: React.FC<AgentGIconProps> = ({
  className = "",
  size = 64,
}) => {
  return (
    <svg
      className={`holographic-icon agent-g-icon ${className}`}
      width={size}
      height={size}
      viewBox="0 0 64 64"
    ...
    >
      <defs>
        <linearGradient id="agentGradientG" x1="0%" y1="0%" x2="100%" y2="100%">
